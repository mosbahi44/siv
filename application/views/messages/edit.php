            ...
            <div class="panel">
                <div class="panel-content">
                    ...
                    <div class="form-group">
                        ...
                        echo $CI->getShelterName($messagex->id_shelter, array('class'=>'form-control'));
                        ?>
                    </div>
                    <div class="form-group">
                        <?php
                        echo form_label('Message');
                        echo form_input('message', $messagex->message, array('class'=>'form-control'));
                        ?>
                    </div>
                    <div class="form-group">
                        <?php
                        ...
                        <select name="color" class="form-control">
                            ...
                            foreach($colors as $key => $value):
                                ?>
                                <option value="#<?= $key;?>" style="color:#fff; background-color:#<?=$key;?> "
                                <?php if(str_replace('#','',$messagex->color) == $key) echo ' selected="selected"';?>
                                ><?= $value;?></option>
                                <?php
                            endforeach;
                            ?>
                    ...
                    <div class="form-group">
                        ...
                        <select name="background" class="form-control">
                            ...
                            foreach($colors as $key => $value):
                                ?>
                                <option value="#<?= $key;?>" style="color:#fff; background-color:#<?=$key;?> "
                                    <?php if(str_replace('#','',$messagex->background) == $key) echo ' selected="selected"';?>
                                ><?= $value;?></option>
                                <?php
                            endforeach;
                            ?>
